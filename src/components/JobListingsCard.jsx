...
const JobListingsCard = ({ type, title, description, salary, location , id}) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md relative">
              <div className="p-4">
                ...
                <button onClick={() => setShowDescription((prevState) => !prevState)} className="text-indigo-500 hover:text-indigo-600 mb-2">
                    {
